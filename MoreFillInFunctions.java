/*
 * Project: MoreFillInFunctions
 * Description: Complete the program by adding method calls to already-defined methods
 * so that the program runs and produces the expected output.
 */
